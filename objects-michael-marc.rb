...
class ColorPalette
    ...
    def all_color
         "The three colors of #{@color} are #{@shade1}, #{@shade2}, and #{@shade3}"
     end
end
...
p red = ColorPalette.new('red', 'Kinda red', 'super red', 'very red')
p blue = ColorPalette.new('blue', 'Kinda blue', 'super blue', 'very blue')
...
class Salmon < Fish
    ...
    def show_info
        if @alive
            "This salmon is alive and has an age of #{@age}, #{@type} type and has a species of #{@species}. "
        else
            "This salmon is dead and has an age of #{@age}, #{@type} type and has a species of #{@species}. "
        end
    end
end
